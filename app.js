...
app.get('/dashboard', isAuth, async (req, res) => {
    var passage = 'gale was a unique dinosaur known for its exceptional intelligence and love for strategy games despite being an excellent chess player gale could never seem to break the fifteen fifty rating barrier it was a source of frustration for the dinosaur who was always eager to improve its skills and prove its worth on the chessboard despite its best efforts gale just couldnt seem to get past this rating plateau however this did not dampen its love for the game and it continued to play chess every day always searching for new strategies and ways to improve eventually gales dedication and hard work paid off and it finally broke the fifteen fifty rating barrier much to its delight from that day on gale was regarded as one of the top chess players in the dinosaur world'
